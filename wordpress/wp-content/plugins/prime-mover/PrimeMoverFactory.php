...
class PrimeMoverFactory
{
    ...
    public function primeMoverCleanUpOnUninstall()
    {
        ...
        $this->removePluginConstantScriptOnUninstall();
    ...
    /**
     * Maybe remove constant script if it exists
     */
    private function removePluginConstantScriptOnUninstall()
    {
        $cons_script = trailingslashit(WPMU_PLUGIN_DIR) . '000-prime-mover-constants.php';
        if (!file_exists($cons_script)) {
            return;
        }
        unlink($cons_script);
    }
