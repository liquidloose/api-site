...
class PrimeMoverExporter implements PrimeMoverExport
{
    ...
    private function executeDumpUsingPHP($filter_export_data = false, $target_path = '', $clean_tables = [], $ret = [], $db_dump_start = 0)
    {
        ...
        try {
            ...
            foreach ($clean_tables as $key => $table) {
                ...
                while ($dumped_rows = $this->triggerMySQLDumpPHP($mysql_server, $table, $filter_export_data, $target_path, $i, $batch_size, $clean_tables, $table_count, $primary_keys, $orderbykeys, $left_off, $table_processed)) {
    ...
    private function triggerMySQLDumpPHP($mysql_server = '', $table = '', $filter_export_data = false, $target_path = '', 
        $i = 0, $batch_size = 10, $clean_tables = [], $table_count = 0, $primary_keys = [], $orderbykeys = [], $left_off = [], $table_processed = 0)
    {
    ...
    public function generateLanguageFilesList($ret = [], $blogid_to_export = 0, $start_time = 0)
    {
        ...
        $locale = $this->getSystemInitialization()->getLocaleOfExportedSite();               
        ...
        do_action('prime_mover_log_processed_events', "Generating language files for exporting belonging to locale: $locale", $this->getSystemInitialization()->getExportBlogID(), 'export', __FUNCTION__, $this);
